    ...
    <div className='p-3 md:mx-auto'>
      <div className='flex-wrap flex gap-4 justify-center'>
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 text-md uppercase'>Usuarios totales</h3>
        ...
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 text-md uppercase'>Publicaciones totales</h3>
      ...
      <div className='flex flex-wrap gap-4 py-3 mx-auto justify-center'>
        ...
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
          ...
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell>Imagen de publicacion</Table.HeadCell>
              <Table.HeadCell>Titulo de publicacion</Table.HeadCell>
