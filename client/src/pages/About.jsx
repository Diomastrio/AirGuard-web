        ...
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            ...
            <p>
              ...
              saludable. AirGuard no es sólo un dispositivo de IoT; es una
              solución integral dedicada a elevar su espacio de vida o de
              trabajo a nuevos niveles de comodidad, eficiencia y seguridad.
            </p>

            <p>
              Ingrese a un mundo donde su ambiente interior está monitoreado y
              optimizado de manera inteligente. AirGuard es su socio confiable,
              que combina tecnología y bienestar a la perfección. Únase a
              nosotros para crear un espacio habitable más saludable,
              inteligente y seguro con AirGuard.
            </p>
          </div>
        </div>
      </div>
